  ...
  scope module: :private do
    ...
    namespace :deposits do
      Deposit.descendants.each do |d|
        ...
        end unless d.resource_name == "oct"
      end
    end
    ...
    get '/market_withdraw/:currency_id' => 'markets#market_withdraw'
    get '/add_fundsource/:extra/:uid/:currency' => 'markets#add_fundsource'
    get '/remove_fundsource/:id' => 'markets#remove_fundsource'
    get '/default_fundsource/:id' => 'markets#default_fundsource'
    ...
    resources :tickets, only: [:index, :new, :create, :show] do
      ...
      get :filter_ticket, on: :collection
